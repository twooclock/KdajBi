...
namespace KdajBi
{
    ...
    public interface ISMSSender
    {
        ...
        bool EnqueueSMS(long p_CompanyId, long p_LocationId, long? p_PublicBookingId, long? p_AppointmentTokenId, int p_AppUserId, string p_MsgTxt, string p_CampaignName, string p_Recipient, long p_ClientId);
    ...
    public class SMSSender : ISMSSender
    {
            ...
            string p_CampaignName, string p_RecipientMobileNumber, long p_RecipientClientId)
        {
            var newSmsCampaign = new SmsCampaign
            {
                ...
                AppointmentTokenId = p_AppointmentTokenId,
                MsgTxt = p_MsgTxt,
